package com.wangrunsheng.snote.activity;
...
import com.wangrunsheng.snote.R;
import com.wangrunsheng.snote.adapter.NoteAdapter;
import com.wangrunsheng.snote.data.ConstantData;
import com.wangrunsheng.snote.data.SNoteDB;
import com.wangrunsheng.snote.listener.MyAnimationListener;
import com.wangrunsheng.snote.listener.MyHideAnimationListener;
import com.wangrunsheng.snote.model.NoteModel;
import com.wangrunsheng.snote.utils.CommonUtils;
import com.wangrunsheng.snote.drag.DragSortController;
import com.wangrunsheng.snote.drag.DragSortListView;
...
public class MainActivity extends Activity {
    ...
    private void initView() {
        sNoteDB = SNoteDB.getInstance(this);
        ...
        edittext_search.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                List<NoteModel> newList = sNoteDB.searchNotesByStr(searchStr);
                dataList.clear();
    ...
    public void backToList(View view) {
        ...
        List<NoteModel> newList = sNoteDB.loadNotes();
        dataList.addAll(newList);
        if (noteAdapter != null) {
            noteAdapter.notifyDataSetChanged();
        }
            ...
            public void run() {
                ...
                zoom_translate.setAnimationListener(new AnimationListener() {
                    ...
                    public void onAnimationEnd(Animation animation) {
                        ...
                        sNoteDB.deleteNote(noteModel.getNoteId());
    ...
    public void doFinish(View view) {
        ...
        if (noteContent != null && noteContent.length() > 0) {
            ...
            int noteId = sNoteDB.saveNote(noteModel);
