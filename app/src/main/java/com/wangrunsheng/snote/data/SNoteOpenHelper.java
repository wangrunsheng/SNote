...
public class SNoteOpenHelper extends SQLiteOpenHelper{

	public static final String TAB_NAME = "snote";
//	public static final String NOTE_RANKID = "note_rankId";
	...
	public SNoteOpenHelper(Context context, String name, CursorFactory factory,
						   int version) {
